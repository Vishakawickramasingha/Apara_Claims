...
<head>
    <meta charset="UTF-8">
    <title>Approved Claims | APARA</title>
    ...
    <style>
        ...
        /* Summary card style */
        .summary-card {
            background: linear-gradient(135deg, #01512c, #83f592);
            color: white;
            text-align: center;
            padding: 25px 15px;
            border-radius: 12px;
...
<div class="layout">
    ...
    <div class="page-content">
        ...
        <h3 class="mb-4 text-success">Approved Claims</h3>

        <!-- SUMMARY CARD -->
        <div class="row mb-4">
            <div class="col-md-4">
                <div class="summary-card">
                    <h6>Total Approved Claims</h6>
                    <h3>75</h3>
                </div>
            </div>
        </div>
